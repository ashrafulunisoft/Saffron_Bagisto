...
>
    ...
    <body dir="{{ core()->getCurrentLocale()->direction }}">
        <div class="logo-container {{ core()->getCurrentLocale()->direction }}">
            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('themes/admin/default/build/assets/Saffron__Logo_Removebg.png'))) }}"
            alt="Saffron Sweets And Backery"
            style="height: 50px; width: 110px;"
            />
            <h2 class="company-name text-info font-weight-bold fs-1" style="color: #000DBB">Saffron Sweets And Backery</h2>
            @if (core()->getConfigData('sales.invoice_settings.pdf_print_outs.logo'))
            {{-- <h2 class="company-name text-primary">Saffron Sweets And Backer</h2> --}}
