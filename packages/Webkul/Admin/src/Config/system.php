...
return [
    ...
    [
        ...
        'key'    => 'sales.payment_methods.online_payment',
        'name'   => 'Online Payment',
        'info'   => 'Unified payment gateway for SSLCommerz, bKash, Nagad and Rocket',
        'sort'   => 5,
        'fields' => [
            [
                'name'          => 'title',
                ...
                'title'         => 'Nagad Merchant ID',
                'type'          => 'text',
                'depends'       => 'gateway:nagad',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'nagad_sandbox',
                ...
                'title'         => 'Rocket Merchant ID',
                'type'          => 'text',
                'depends'       => 'gateway:rocket',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'rocket_sandbox',
